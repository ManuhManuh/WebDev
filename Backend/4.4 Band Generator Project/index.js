...
app.post("/submit", (req, res) => {
  ...
  var adjectiveIndex = Math.floor(Math.random() * adj.length);
  var nounIndex = Math.floor(Math.random() * noun.length);
  //2. Send the index.ejs as a response and add the adjective and noun to the res.render
  const bandName = adj[adjectiveIndex] + " " + noun[nounIndex]
  //const bandName = adj[0] + " " + noun[0]
  res.render("index.ejs", { randomName: bandName });
